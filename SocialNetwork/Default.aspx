                        ...
                        <section>
                            ...
                            <div class="row">
                                <div class="12u 12u(mobile)">
                                    ...
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="login" ControlToValidate="txtUsername" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Enter your username!"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="12u 12u(mobile)">
                                    ...
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="login" ControlToValidate="txtPassword" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Enter your password!"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        ...
                        <section>
                            ...
                            <div class="row">
                                <div class="6u 12u(mobile)">
                                    ...
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="reg" ControlToValidate="txtNewUser" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Enter a username!"></asp:RequiredFieldValidator>
                                </div>
                                <div class="6u 12u(mobile)">
                                    Email Address:<br />
                                    <asp:TextBox ID="txtEmail" runat="server" MaxLength="255" Width="80%"></asp:TextBox>
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="reg" ControlToValidate="txtEmail" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Enter your email address!"></asp:RequiredFieldValidator>
                            ...
                            <div class="row">
                                <div class="6u 12u(mobile)">
                                    ...
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="reg" ControlToValidate="txtFN" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Enter your first name!"></asp:RequiredFieldValidator>
                                </div>
                                <div class="6u 12u(mobile)">
                                    Last Name:<br />
                                    <asp:TextBox ID="txtLN" runat="server" MaxLength="150" Width="80%"></asp:TextBox>
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="reg" ControlToValidate="txtLN" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Enter your last name!"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="6u 12u(mobile)">
                                    ...
                                    <ajaxToolkit:MaskedEditExtender
                                        ...
                                        Mask="99/99/9999"
                                        MaskType="Date"
                                        MessageValidatorTip="true"></ajaxToolkit:MaskedEditExtender>
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="reg" ControlToValidate="txtDOB" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Enter your date of birth!"></asp:RequiredFieldValidator>
                                </div>
                                <div class="6u 12u(mobile)">
                                    Gender:<br />
                                    ...
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="reg" ControlToValidate="ddlGender" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Select your gender!"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="6u 12u(mobile)">
                                    ...
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="reg" ControlToValidate="txtNewPwd" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Choose a password!"></asp:RequiredFieldValidator>
                                </div>
                                <div class="6u 12u(mobile)">
                                    Repeat Password:<br />
                                    <asp:TextBox ID="txtRptPwd" runat="server" TextMode="Password" Width="80%"></asp:TextBox>
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="reg" ControlToValidate="txtRptPwd" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Re-enter your chosen password!"></asp:RequiredFieldValidator>
                            ...
                            <div class="row">
                                <div class="6u 12u(mobile)">
                                    ...
                                    <br>
                                    <asp:RequiredFieldValidator ValidationGroup="reg" ControlToValidate="ddlCountry" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="Select your country!"></asp:RequiredFieldValidator>
                                </div>
                                <div class="6u 12u(mobile)">
                                </div>
                            </div>
